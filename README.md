...
- **Analytics & BI:** Power BI (Reporting, KPIs), Excel (Advanced Financial Modeling).
- **Database & SQL:** MS SQL Server, Data Querying, Operational Reporting.
- **Automation:** Python (Data Manipulation, Operational Reporting).

---

### 📊 Featured Projects
- **Loan Processing System** – Business requirements document for digitizing loan approval workflows.  
- **Smart Water Pump Monitoring System** – Predictive monitoring BRD for real-time alerts and reduced pump failures.  
- **Automobile Dashboard Analysis** – Power BI project for sales, targets, and regional insight analysis.  
- **Sales Analysis Dashboard** – Interactive dashboard for tracking sales trends, profit, and customer performance.  
- **Financial Analysis Decision Making** - Excel modeling project for loan, annuity, NPV, and IRR analysis.
- **Depreciation Methods Analysis** - Comparative Excel analysis of SLM and DBM depreciation techniques.
